export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote TabHub server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'TabHub Cloud',
