export default {
  ...
  'createGuide.func1.title': 'Submit in TabHub',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the TabHub Community.',
  'footer.title': 'Share your creation on TabHub Community today',
  ...
  'models.providerInfo.apiTooltip': 'TabHub supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'TabHub Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on TabAI',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by TabHub automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the TabHub marketplace with one click.',
