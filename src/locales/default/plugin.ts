export default {
  ...
  'protocolInstall.official.badge': 'TabHub Official Skill',
  'protocolInstall.official.description': 'Official TabHub Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. TabHub does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Add skills to Tab AI',
