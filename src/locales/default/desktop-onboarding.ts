export default {
  ...
  'authResult.success.desc': 'Please click the Start button below to continue using TabHub Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve TabHub. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve TabHub',
  ...
  'screen5.actions.signInCloud': 'Sign in to TabHub Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your TabHub Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'TabHub Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own TabHub server instance',
