export default {
  ...
  'memory.enabled.desc':
    'Allow TabHub to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'TabHub CLI - manage and connect to TabHub services',
  ...
  'skillStore.tabs.lobehub': 'TabHub',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the TabHub marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the TabHub platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'TabHub',
